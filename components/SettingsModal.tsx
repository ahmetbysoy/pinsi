  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 bg-[#0d1117] p-3 sm:p-4 overflow-y-auto select-none">
      <div className="max-w-4xl mx-auto w-full flex flex-col gap-4">
        {/* Header */}
        <div className="bg-[#12161c] border border-[#22272e] rounded-xl p-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Sliders className="w-5 h-5 text-emerald-400" />
            <div>
              <h2 className="text-sm font-bold text-slate-100">SİSTEM VE MOTOR AYARLARI</h2>
