...
export const FlowMetricsPanel: React.FC<FlowMetricsPanelProps> = ({
  ...
  const renderRibbon = () => (
    <div className="flex items-center gap-3 overflow-x-auto no-scrollbar py-1 text-[11px] font-mono whitespace-nowrap">
      <div className="flex items-center gap-1.5 bg-[#161b22] px-2 py-1 rounded border border-[#22272e]">
      ...
      <div className="flex items-center gap-1.5 bg-[#161b22] px-2 py-1 rounded border border-[#22272e]">
        <span className="text-slate-500">Liq 60s:</span>
      ...
      <div className="flex items-center gap-1.5 bg-[#161b22] px-2 py-1 rounded border border-[#22272e]">
        <span className="text-slate-500">Duvarlar:</span>
  ...
  if (mode === 'ribbon') {
    return (
      <div className="bg-[#12161c] border-b border-[#22272e] px-3 py-1.5 text-xs">
        {renderRibbon()}
      </div>
    );
  }
    ...
    <div className="bg-[#12161c] border-b border-[#22272e] px-3 py-1.5 text-xs">
      <div className="flex items-center justify-between gap-2">
        ...
        <button
          ...
          className="flex items-center gap-1 px-2 py-1 bg-[#161b22] hover:bg-[#1f242c] border border-[#22272e] rounded text-slate-400 hover:text-slate-200 text-[11px] font-mono transition-colors shrink-0"
